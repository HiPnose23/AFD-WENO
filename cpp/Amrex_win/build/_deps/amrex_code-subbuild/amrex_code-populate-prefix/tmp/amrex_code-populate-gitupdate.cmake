...
function(do_fetch)
  ...
  execute_process(
    COMMAND "/cluster/software/stacks/2024-06/sfos/git" --git-dir=.git fetch --tags --force "origin"
...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "/cluster/software/stacks/2024-06/sfos/git" --git-dir=.git rev-parse "${ref}^0"
    WORKING_DIRECTORY "/cluster/home/mkryukov/Thesis/Amrex/build/_deps/amrex_code-src"
...
execute_process(
  COMMAND "/cluster/software/stacks/2024-06/sfos/git" --git-dir=.git show-ref "origin/development"
  WORKING_DIRECTORY "/cluster/home/mkryukov/Thesis/Amrex/build/_deps/amrex_code-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"origin/development\" is not present locally, and not "
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "/cluster/software/stacks/2024-06/sfos/git" --git-dir=.git symbolic-ref -q HEAD
    WORKING_DIRECTORY "/cluster/home/mkryukov/Thesis/Amrex/build/_deps/amrex_code-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "/cluster/software/stacks/2024-06/sfos/git" --git-dir=.git for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "/cluster/home/mkryukov/Thesis/Amrex/build/_deps/amrex_code-src"
...
execute_process(
  COMMAND "/cluster/software/stacks/2024-06/sfos/git" --git-dir=.git status --porcelain
  WORKING_DIRECTORY "/cluster/home/mkryukov/Thesis/Amrex/build/_deps/amrex_code-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "/cluster/software/stacks/2024-06/sfos/git" --git-dir=.git stash save --quiet;--include-untracked
    WORKING_DIRECTORY "/cluster/home/mkryukov/Thesis/Amrex/build/_deps/amrex_code-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "/cluster/software/stacks/2024-06/sfos/git" --git-dir=.git checkout "${checkout_name}"
    WORKING_DIRECTORY "/cluster/home/mkryukov/Thesis/Amrex/build/_deps/amrex_code-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "/cluster/software/stacks/2024-06/sfos/git" --git-dir=.git rebase "${checkout_name}"
    WORKING_DIRECTORY "/cluster/home/mkryukov/Thesis/Amrex/build/_deps/amrex_code-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/cluster/software/stacks/2024-06/sfos/git" --git-dir=.git rebase --abort
      WORKING_DIRECTORY "/cluster/home/mkryukov/Thesis/Amrex/build/_deps/amrex_code-src"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "/cluster/software/stacks/2024-06/sfos/git" --git-dir=.git stash pop --index --quiet
          WORKING_DIRECTORY "/cluster/home/mkryukov/Thesis/Amrex/build/_deps/amrex_code-src"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: '/cluster/home/mkryukov/Thesis/Amrex/build/_deps/amrex_code-src'."
    ...
    execute_process(
      COMMAND "/cluster/software/stacks/2024-06/sfos/git" --git-dir=.git tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/cluster/software/stacks/2024-06/sfos/git" --git-dir=.git reset --hard --quiet
      WORKING_DIRECTORY "/cluster/home/mkryukov/Thesis/Amrex/build/_deps/amrex_code-src"
    )
    execute_process(
      COMMAND "/cluster/software/stacks/2024-06/sfos/git" --git-dir=.git stash pop --quiet
      WORKING_DIRECTORY "/cluster/home/mkryukov/Thesis/Amrex/build/_deps/amrex_code-src"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "/cluster/software/stacks/2024-06/sfos/git" --git-dir=.git reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "/cluster/home/mkryukov/Thesis/Amrex/build/_deps/amrex_code-src"
      )
      execute_process(
        COMMAND "/cluster/software/stacks/2024-06/sfos/git" --git-dir=.git stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/cluster/home/mkryukov/Thesis/Amrex/build/_deps/amrex_code-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
